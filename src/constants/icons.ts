...
const iconSvgData: Record<string, string> = {
	...
	"local:tag-rounded":
		'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024"> <path fill="currentColor" d="M693.12 164.96l237.12 240.48c44.32 44.96 44.32 116.96 0 161.92L680 820.64c-14.88 15.04-39.2 15.2-54.24 0.32-15.04-14.88-15.2-39.2-0.32-54.24l250.24-253.44c14.72-14.88 14.72-39.04 0-53.92L638.4 219.04c-14.88-15.04-14.72-39.36 0.32-54.24 15.04-14.88 39.36-14.72 54.24 0.32z"/> <path fill="currentColor" d="M102.56 469.6V256c0-56.48 45.92-102.4 102.4-102.4h213.6c27.2 0 53.28 10.72 72.48 29.92l230.4 230.4c40 40 40 104.8 0 144.8L507.84 772.32c-40 40-104.8 40-144.8 0l-230.4-230.4c-19.2-19.2-29.92-45.28-29.92-72.48z m230.4-136.8c0-28.32-22.88-51.2-51.2-51.2s-51.2 22.88-51.2 51.2 22.88 51.2 51.2 51.2 51.2-22.88 51.2-51.2z"/> </svg>',
